 ...
 * @author Baoyi Chen
 */
public class CsvRdbVisitor extends BaseRdbVisitor {
    public CsvRdbVisitor(Replicator replicator, File out, Long db, String keyRegEx, Long top, List<Type> types, Escape escape) throws Exception {

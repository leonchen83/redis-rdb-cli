...
public class RctCommand extends AbstractCommand {
    ...
    private static final Option FORMAT = Option.builder("f").longOpt("format").required(false).hasArg().argName("format").type(String.class).desc("format to export. valid formats are json, diff, key, keyval, mem and resp").build();

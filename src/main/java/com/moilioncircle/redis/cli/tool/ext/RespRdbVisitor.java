 ...
 * @author Baoyi Chen
 */
public class RespRdbVisitor extends BaseRdbVisitor {
    public RespRdbVisitor(Replicator replicator, File out, List<Long> db, List<String> regexs, Long top, List<Type> types, Escape escape) throws Exception {

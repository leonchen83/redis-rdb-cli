 ...
 * @author Baoyi Chen
 */
public abstract class AbstractRmtRdbVisitor extends BaseRdbVisitor {
	...
	public AbstractRmtRdbVisitor(Replicator replicator, Configure configure, Filter filter, boolean replace) {
